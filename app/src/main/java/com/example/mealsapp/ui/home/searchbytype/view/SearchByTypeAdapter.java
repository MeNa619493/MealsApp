...
public class SearchByTypeAdapter extends ListAdapter<Meal, SearchByTypeAdapter.ViewHolder> {
    private Context context;
    private OnMealClickListener clickListener;

    public SearchByTypeAdapter(Context context, OnMealClickListener clickListener) {
